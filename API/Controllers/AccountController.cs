using API._Services.Interfaces.Account;
using API.Dtos;
...
public class AccountController : BaseAPIController
{
    ...
    {
        return await GetUserById(UserUtilities.GetUserId(User));
    }
    ...
    {
        return await UpdateUser(UserUtilities.GetUserId(User), user);
    }
    ...
    public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (UserUtilities.GetUserId(User) == id)
            {
    ...
    {
        return await UpdateUser(UserUtilities.GetUserId(User), patch);
    }
    ...
    {
        var userId = UserUtilities.GetUserId(User);
    ...
    public async Task<IActionResult> GetRoleByName(string name)
    {
        ...
        var roleVM = await GetRoleDtoHelper(name);
    ...
    public async Task<IActionResult> CreateRole([FromBody] RoleDto role)
    {
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                var roleVM = await GetRoleDtoHelper(appRole.Name);
    ...
    {
        return Ok(_mapper.Map<List<PermissionViewModel>>(Helpers.Authorization.ApplicationPermissions.AllPermissions));
    }
    ...
    private async Task<RoleDto> GetRoleDtoHelper(string roleName)
    {
